...
API Key 在 [千图AI 开放平台](https://ai.58pic.com/mcp) 创建。
...
| **API Key** | 不支持 OAuth 的客户端、服务端调用、CI/CD | [千图AI 开放平台](https://ai.58pic.com/mcp) 创建 |
...
- 🌐 [千图AI 开放平台](https://ai.58pic.com/mcp)
- 🔧 [CLI 工具](https://github.com/58pic-open/cli)
- 🧩 [Agent Skills](https://github.com/58pic-open/skills)
